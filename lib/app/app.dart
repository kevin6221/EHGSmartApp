...
/// Root application widget configuring global providers, theming, and routing.
  ...
  Widget build(BuildContext context) {
    ...
    return MultiRepositoryProvider(
      ...
      child: MultiBlocProvider(
        ...
        child: MaterialApp(
          title: AppConfig.isInitialized
              ? AppConfig.instance.flavor.appName
              : AppFlavor.dev.appName,
